...
STYLE_PRESETS = {
    "auto": {
        ...
        "pitch_hz": 8,
        "volume_pct": 0,
        "description": "Automatic emotional adjustment."
    },
    ...
    "default": {
        ...
        "pitch_hz": 8,
        "volume_pct": 0,
        "description": "Balanced female preset."
    },
    ...
    "female_natural": {
        ...
        "pitch_hz": 10,
        "volume_pct": 0,
        "description": "More natural female voice."
    },
...
def _resolve_voice_payload(
    ...
    resolved_voice = _resolve_voice_alias(
        requested_voice
    )
    ...
    provider_voice = VOICE_PROVIDER_MAP.get(
        resolved_voice,
        VOICE_PROVIDER_MAP["pt_br_female"]
    )
    ...
    return {
        ...
        "style_description": STYLE_PRESETS.get(
            style_key,
            STYLE_PRESETS["default"]
        )["description"],
...
async def chat(
    ...
    emo_raw = result.get("emotional_state") or {
        "valence": 0.0,
        "arousal": 0.0,
        "label": "neutra"
    }
...
async def voice_tts_info(_=Depends(protect)):
    return {
        ...
        "voices_supported": list(
            VOICE_PROVIDER_MAP.keys()
        ),

        "styles": STYLE_PRESETS,

        "effects_supported": list(
            EFFECT_DELTAS.keys()
        ),

        "emotion_profiles": list(
            EMOTION_PRESETS.keys()
        )
    }
